  ...
  return (
    <header className="bg-white shadow">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="text-xl font-bold bg-gray-200 text-orange-500 px-4 py-2 hover:bg-orange-500 hover:text-gray-200 cursor-pointer hover:shadow">
          Logo
        </div>
        <div className="flex space-x-4 border-2 px-4 py-2 rounded-full bg-white border-gray-100">
          <button className="flex px-4 py-2 text-gray-500 font-medium hover:text-white hover:bg-orange-500 hover:rounded-full">
            <span>
              <svg
                width="22"
                height="21"
          ...
          <button className="flex px-4 py-2 text-gray-500 font-bold hover:text-white hover:bg-orange-500 hover:rounded-full">
            <span>
              <svg
                width="24"
                height="25"
