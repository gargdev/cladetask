...
const Navigation = () => {
  return (
    <div className='flex items-center space-x-8 h-10 shadow px-40 py-6'>
        <Link to="/"><div className="text-gray-600 font-semibold hover:underline underline-offset-[18px] decoration-2 hover:text-orange-500 cursor-pointer">Job Preview</div></Link>
